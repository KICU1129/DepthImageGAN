...
from opt import Opts,AnimeOpts
from utils import *
from database import ImageDataset,AnimeDataset
...
dataset=AnimeDataset(depth_name=opt.depth_name,depth_gray=opt.domainB_nc==1,root=opt.dataroot,
                     transforms_=transforms_, limit=opt.limit,unaligned=opt.unaligned)
test_dataset=AnimeDataset(depth_name=opt.depth_name,depth_gray=opt.domainB_nc==1,root=opt.dataroot,
