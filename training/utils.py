...
class Recoder:
    ...
    def _save(self,img_list,path,fig_path,cmode="jet"):
        ...
        for i in range(k):
            ...
            a=ax.imshow(img_list["real_B"][i], cmap=cmode, vmin = 0, vmax =255)
            ax.axis("off")
            ...
            a=ax.imshow(img_list["fake_B"][i], cmap=cmode, vmin = 0, vmax =255)
            ax.axis("off")
            fig.colorbar(a, ax=ax)
            ...
            a=ax.imshow(img_list["cycle_B"][i], cmap=cmode, vmin = 0, vmax =255)
            ax.axis("off")
            fig.colorbar(a, ax=ax)
